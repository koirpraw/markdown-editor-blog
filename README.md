...
7. ASG with Dockerized EC2 Instances to simplify the deployment process without using complex configuration management (optimized for faster launch times and easier updates).
8. ASG- Dockeroized step above but using Spot Instances to further optimize costs.
